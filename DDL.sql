...
IF OBJECT_ID('results_v1.dbo.cohort', 'U') IS NULL
CREATE TABLE results_v1.dbo.cohort
(
...
IF OBJECT_ID('results_v1.dbo.cohort_censor_stats', 'U') IS NULL
CREATE TABLE results_v1.dbo.cohort_censor_stats(
  cohort_definition_id int NOT NULL,
  lost_count BIGINT NOT NULL
);


IF OBJECT_ID('results_v1.dbo.cohort_inclusion', 'U') IS NULL
CREATE TABLE results_v1.dbo.cohort_inclusion(
  cohort_definition_id int NOT NULL,
...
IF OBJECT_ID('results_v1.dbo.cohort_inclusion_result', 'U') IS NULL
CREATE TABLE results_v1.dbo.cohort_inclusion_result(
  cohort_definition_id int NOT NULL,
...
IF OBJECT_ID('results_v1.dbo.cohort_inclusion_stats', 'U') IS NULL
CREATE TABLE results_v1.dbo.cohort_inclusion_stats(
  cohort_definition_id int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
...
IF OBJECT_ID('results_v1.dbo.cohort_summary_stats', 'U') IS NULL
CREATE TABLE results_v1.dbo.cohort_summary_stats(
  cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
...
IF OBJECT_ID('results_v1.dbo.cohort_cache', 'U') IS NULL
CREATE TABLE results_v1.dbo.cohort_cache (
...
IF OBJECT_ID('results_v1.dbo.cohort_censor_stats_cache', 'U') IS NULL
CREATE TABLE results_v1.dbo.cohort_censor_stats_cache (
  design_hash int NOT NULL,
  lost_count BIGINT NOT NULL
);


IF OBJECT_ID('results_v1.dbo.cohort_inclusion_result_cache', 'U') IS NULL
CREATE TABLE results_v1.dbo.cohort_inclusion_result_cache (
  design_hash int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
...
IF OBJECT_ID('results_v1.dbo.cohort_inclusion_stats_cache', 'U') IS NULL
CREATE TABLE results_v1.dbo.cohort_inclusion_stats_cache (
  design_hash int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
...
IF OBJECT_ID('results_v1.dbo.cohort_summary_stats_cache', 'U') IS NULL
CREATE TABLE results_v1.dbo.cohort_summary_stats_cache (
  design_hash int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
...
IF OBJECT_ID('results_v1.dbo.feas_study_inclusion_stats', 'U') IS NULL
CREATE TABLE results_v1.dbo.feas_study_inclusion_stats(
...
IF OBJECT_ID('results_v1.dbo.feas_study_index_stats', 'U') IS NULL
CREATE TABLE results_v1.dbo.feas_study_index_stats(
  study_id int NOT NULL,
  person_count bigint NOT NULL,
...
IF OBJECT_ID('results_v1.dbo.feas_study_result', 'U') IS NULL
CREATE TABLE results_v1.dbo.feas_study_result(
  study_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);
...
IF OBJECT_ID('results_v1.dbo.heracles_analysis', 'U') IS NULL
CREATE TABLE results_v1.dbo.heracles_analysis
(
	analysis_id int,
...
IF OBJECT_ID('results_v1.dbo.HERACLES_HEEL_results', 'U') IS NULL
CREATE TABLE results_v1.dbo.HERACLES_HEEL_results 
( 
...
IF OBJECT_ID('results_v1.dbo.heracles_results', 'U') IS NULL
create table results_v1.dbo.heracles_results
(
	cohort_definition_id int,
	analysis_id int,
...
--HINT PARTITION(cohort_definition_id int)
--HINT BUCKET(analysis_id, 64)
IF OBJECT_ID('results_v1.dbo.heracles_results_dist', 'U') IS NULL
create table results_v1.dbo.heracles_results_dist
(
	cohort_definition_id int,
	analysis_id int,
	stratum_1 varchar(255),
...
IF OBJECT_ID('results_v1.dbo.heracles_periods', 'U') IS NULL
CREATE TABLE results_v1.dbo.heracles_periods
(
	period_id int,
  period_order int,
...
IF OBJECT_ID('results_v1.dbo.cohort_sample_element', 'U') IS NULL
CREATE TABLE results_v1.dbo.cohort_sample_element(
...
IF OBJECT_ID('results_v1.dbo.ir_analysis_dist', 'U') IS NULL
CREATE TABLE results_v1.dbo.ir_analysis_dist (
...
IF OBJECT_ID('results_v1.dbo.ir_analysis_result', 'U') IS NULL
CREATE TABLE results_v1.dbo.ir_analysis_result(
  analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
IF OBJECT_ID('results_v1.dbo.ir_analysis_strata_stats', 'U') IS NULL
CREATE TABLE results_v1.dbo.ir_analysis_strata_stats(
  analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
IF OBJECT_ID('results_v1.dbo.ir_strata', 'U') IS NULL
CREATE TABLE results_v1.dbo.ir_strata(
  analysis_id int NOT NULL,
  strata_sequence int NOT NULL,
  name varchar(255) NULL,
  description varchar(1000) NULL
...
IF OBJECT_ID('results_v1.dbo.cc_results', 'U') IS NULL
CREATE TABLE results_v1.dbo.cc_results
(
...
IF OBJECT_ID('results_v1.dbo.pathway_analysis_codes', 'U') IS NULL
CREATE TABLE results_v1.dbo.pathway_analysis_codes
(
...
IF OBJECT_ID('results_v1.dbo.pathway_analysis_events', 'U') IS NULL
CREATE TABLE results_v1.dbo.pathway_analysis_events
(
	pathway_analysis_generation_id BIGINT NOT NULL,
...
IF OBJECT_ID('results_v1.dbo.pathway_analysis_paths', 'U') IS NULL
CREATE TABLE results_v1.dbo.pathway_analysis_paths
(
	pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
  step_1 BIGINT,
...
IF OBJECT_ID('results_v1.dbo.pathway_analysis_stats', 'U') IS NULL
CREATE TABLE results_v1.dbo.pathway_analysis_stats
(
  pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
...
IF OBJECT_ID('results_v1.dbo.concept_hierarchy', 'U') IS NULL
CREATE TABLE results_v1.dbo.concept_hierarchy
(
  concept_id             INT,
...
/***********************************************************/
TRUNCATE TABLE results_v1.dbo.concept_hierarchy;

/********** CONDITION/CONDITION_ERA **********/
INSERT INTO results_v1.dbo.concept_hierarchy
...
LEFT JOIN (
	...
	FROM [MOA_CDM20].[dbo].[concept] c1
	INNER JOIN [MOA_CDM20].[dbo].concept_ancestor ca1 ON c1.concept_id = ca1.descendant_concept_id
		AND c1.domain_id = 'Condition'
		AND ca1.min_levels_of_separation = 1
	INNER JOIN [MOA_CDM20].[dbo].[concept] c2 ON ca1.ancestor_concept_id = c2.concept_id
...
LEFT JOIN [MOA_CDM20].[dbo].[concept] soc ON hlgt_to_soc.soc_concept_id = soc.concept_id;
...
LEFT JOIN [MOA_CDM20].[dbo].[concept] atc1 ON atc3_to_atc1.atc1_concept_id = atc1.concept_id;
...
FROM (
	SELECT DISTINCT
		concept_id,
		concept_name
	FROM [MOA_CDM20].[dbo].concept c
	WHERE domain_id = 'Measurement'
) m
LEFT JOIN  [MOA_CDM20].dbo.concept_ancestor ca1 ON M.concept_id = ca1.descendant_concept_id AND ca1.min_levels_of_separation = 1
LEFT JOIN  [MOA_CDM20].dbo.concept c1 ON ca1.ancestor_concept_id = c1.concept_id
LEFT JOIN  [MOA_CDM20].dbo.concept_ancestor ca2 ON c1.concept_id = ca2.descendant_concept_id AND ca2.min_levels_of_separation = 1
LEFT JOIN  [MOA_CDM20].dbo.concept c2 ON ca2.ancestor_concept_id = c2.concept_id
LEFT JOIN  [MOA_CDM20].dbo.concept_ancestor ca3 ON c2.concept_id = ca3.descendant_concept_id AND ca3.min_levels_of_separation = 1
LEFT JOIN  [MOA_CDM20].dbo.concept c3 ON ca3.ancestor_concept_id = c3.concept_id
...
LEFT JOIN  [MOA_CDM20].dbo.concept_ancestor ca1 ON obs.concept_id = ca1.descendant_concept_id AND ca1.min_levels_of_separation = 1
LEFT JOIN  [MOA_CDM20].dbo.concept c1 ON ca1.ancestor_concept_id = c1.concept_id
LEFT JOIN  [MOA_CDM20].dbo.concept_ancestor ca2 ON c1.concept_id = ca2.descendant_concept_id AND ca2.min_levels_of_separation = 1
LEFT JOIN  [MOA_CDM20].dbo.concept c2 ON ca2.ancestor_concept_id = c2.concept_id
LEFT JOIN  [MOA_CDM20].dbo.concept_ancestor ca3 ON c2.concept_id = ca3.descendant_concept_id AND ca3.min_levels_of_separation = 1
...
(
	...
	FROM [MOA_CDM20].[dbo].[concept] c1
	INNER JOIN [MOA_CDM20].dbo.vocabulary v1 ON c1.vocabulary_id = v1.vocabulary_id
...
LEFT JOIN (
	...
	FROM [MOA_CDM20].[dbo].concept_ancestor ca0
	INNER JOIN (
		SELECT DISTINCT c2.concept_id AS os3_concept_id
		FROM [MOA_CDM20].[dbo].concept_ancestor ca1
		INNER JOIN [MOA_CDM20].[dbo].concept c1 ON ca1.descendant_concept_id = c1.concept_id
		INNER JOIN [MOA_CDM20].[dbo].concept_ancestor ca2 ON c1.concept_id = ca2.ancestor_concept_id
		INNER JOIN [MOA_CDM20].[dbo].concept c2 ON ca2.descendant_concept_id = c2.concept_id
...
TRUNCATE TABLE results_v1.dbo.heracles_analysis;


insert into results_v1.dbo.heracles_analysis
...
-- ADD UNION ALLs for[MOA_CDM20].[dbo].conceptional period definitions
) monthlyDates;


TRUNCATE TABLE results_v1.dbo.heracles_periods;


INSERT INTO results_v1.dbo.heracles_periods (period_id, period_name, period_order, period_type, period_start_date, period_end_date)
...
CREATE INDEX HRD_IDX_COHORT_DEF_ID ON results_v1.dbo.HERACLES_RESULTS_DIST (cohort_definition_id);

CREATE INDEX HRD_IDX_COHORT_ID_ANALYSIS_ID ON results_v1.dbo.HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id);

CREATE INDEX HRD_IDX_COHORT_DEF_ID_DT ON results_v1.dbo.HERACLES_RESULTS_DIST (cohort_definition_id, last_update_time);

CREATE INDEX HRD_IDX_COHORT_ID_FIRST_RES ON results_v1.dbo.HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id, count_value, stratum_1);

CREATE INDEX HR_IDX_COHORT_DEF_ID ON results_v1.dbo.HERACLES_RESULTS (cohort_definition_id);

CREATE INDEX HR_IDX_COHORT_ID_ANALYSIS_ID ON results_v1.dbo.HERACLES_RESULTS (cohort_definition_id, analysis_id);

CREATE INDEX HR_IDX_COHORT_ANALYSIS_CONCEPT ON results_v1.dbo.HERACLES_RESULTS (cohort_definition_id, analysis_id) WHERE stratum_2 <> '';

CREATE INDEX HR_IDX_COHORT_DEF_ID_DT ON results_v1.dbo.HERACLES_RESULTS (cohort_definition_id, last_update_time);

CREATE INDEX HR_IDX_COHORT_ID_FIRST_RES ON results_v1.dbo.HERACLES_RESULTS (cohort_definition_id, analysis_id, count_value, stratum_1);

CREATE INDEX HH_IDX_COHORT_ID_ANALYSIS_ID ON results_v1.dbo.HERACLES_HEEL_RESULTS (cohort_definition_id, analysis_id);


CREATE INDEX idx_heracles_periods_startdate ON results_v1.dbo.heracles_periods (period_start_date);

CREATE INDEX idx_heracles_periods_end_date ON results_v1.dbo.heracles_periods (period_end_date);


CREATE INDEX idx_cohort_sample_element_rank ON results_v1.dbo.cohort_sample_element (cohort_sample_id, rank_value);

CREATE INDEX idx_pathway_events_combo_id ON results_v1.dbo.pathway_analysis_events (combo_id);